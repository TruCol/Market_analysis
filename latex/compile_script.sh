...
do
	...
	#assert_file_exists "$OUTPUT_PATH/solidity-highlighting.tex"

	# Copy lipics-v2021.cls style file to output path for Opodis compilation:
	...
	# Copy IEEEtran.cls style file to output path for IEEE 45_software compilation:
	#cp "$PATH_TO_REPORT_TEX/IEEEtran.cls" "$OUTPUT_PATH/$PATH_TO_REPORT_TEX/IEEEtran.cls"
	#assert_file_exists "$OUTPUT_PATH/$PATH_TO_REPORT_TEX/IEEEtran.cls"

	# Copy acmart.cls style file to output path for IEEE 45_software compilation:
	#cp "$PATH_TO_REPORT_TEX/acmart.cls" "$OUTPUT_PATH/$PATH_TO_REPORT_TEX/acmart.cls"
	#assert_file_exists "$OUTPUT_PATH/$PATH_TO_REPORT_TEX/acmart.cls"
